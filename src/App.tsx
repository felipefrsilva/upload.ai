import { Github, FileVideo, Upload, Wand2, Youtube } from "lucide-react";
      ...
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm text-muted-foreground">
            Desenvolvido com 💜 por Felipe Silva no NLW da Rocketseat
          </span>
        ...
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            <Textarea
              ...
              placeholder="Inclua o prompt gerado pela IA..."
            />
            <Textarea
              className="resize-none p-4 leading-relaxed"
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic">
                Você poderá customizar essa opção <b>EM BREVE</b>!
              </span>
            </div>
